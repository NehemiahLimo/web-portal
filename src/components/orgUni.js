...
class orgUni extends Component{
     ...
     this.fetchdata();
      ...
      this.setState({
       ...
       .then(parsedJSON=>parsedJSON.dataElements.map(dataElements=>(
           ...
           dataElementscode: `${dataElements.code}`,
           dataElementslink: `${dataElements.href}`,
           dataShortdescr: `${dataElements.description}`
...

{
               ...
               {region.dataElementDesc}
                             ...
                             <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                               <div class="card-body">dataElementsID: {region.dataElementsID} code:{region.dataElementscode}  link: {region.dataElementslink} description: {region.dataShortdescr}</div>
...
{/*
              ...
              <div class="container container-fluid">
                  ...
                  <button class="btn btn-ssuccess">Export to XML<span class="glyphicon glyphicon-home"></span></button>
